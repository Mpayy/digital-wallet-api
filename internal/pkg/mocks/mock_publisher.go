...
func (_mock *MockPublisher) Publish(ctx context.Context, queueName string, body []byte) error {
	ret := _mock.Called(ctx, queueName, body)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, []byte) error); ok {
		r0 = returnFunc(ctx, queueName, body)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - queueName string
//   - body []byte
func (_e *MockPublisher_Expecter) Publish(ctx any, queueName any, body any) *MockPublisher_Publish_Call {
	return &MockPublisher_Publish_Call{Call: _e.mock.On("Publish", ctx, queueName, body)}
}

func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, queueName string, body []byte)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, queueName string, body []byte) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
